...
import { Key, AlertCircle, Loader, ExternalLink, Github, BookOpen } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800 flex items-center justify-center p-6">
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-700 max-w-md w-full overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-purple-600 to-indigo-600 px-8 py-6 text-center">
          ...
          <h1 className="text-3xl font-bold text-white mb-2">Hengdang Notes</h1>
          <p className="text-purple-100 text-sm">
            Personal knowledge management for the decentralized web
          </p>
        </div>
        ...
        <div className="px-8 py-6">
          <div className="text-center mb-6">
            <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed">
              Sign in with your Nostr extension to access your personal notes vault. 
              Your notes are stored securely on your Hengdang homeserver.
            </p>
          </div>
          ...
          <div className="text-center">
            ...
            <div className="flex items-center justify-center gap-6">
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="flex items-center gap-2 text-xs text-gray-600 dark:text-gray-400 hover:text-purple-600 dark:hover:text-purple-400 transition-colors"
              >
                <Github size={14} />
